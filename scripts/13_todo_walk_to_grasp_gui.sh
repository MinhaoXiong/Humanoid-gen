...
MOMAGEN_START_DIST_MIN=${MOMAGEN_START_DIST_MIN:-"0.7"}
MOMAGEN_START_DIST_MAX=${MOMAGEN_START_DIST_MAX:-"0.7"}
MOMAGEN_TARGET_DIST_MIN=${MOMAGEN_TARGET_DIST_MIN:-"0.7"}
MOMAGEN_TARGET_DIST_MAX=${MOMAGEN_TARGET_DIST_MAX:-"0.7"}
...
echo "[13_todo] Left wrist pose (pelvis): $LEFT_WRIST_POS | $LEFT_WRIST_QUAT_WXYZ"
echo "[13_todo] Right wrist nav pose (pelvis): $RIGHT_WRIST_NAV_POS | $RIGHT_WRIST_NAV_QUAT_WXYZ"
echo "[13_todo] Walk nav speeds: lin=$WALK_NAV_MAX_LIN_SPEED ang=$WALK_NAV_MAX_ANG_SPEED"
echo "[13_todo] Replay base height: $REPLAY_BASE_HEIGHT"
echo "[13_todo] MoMaGen-style: $MOMAGEN_STYLE (start=${MOMAGEN_START_DIST_MIN}-${MOMAGEN_START_DIST_MAX}m, target=${MOMAGEN_TARGET_DIST_MIN}-${MOMAGEN_TARGET_DIST_MAX}m, nav=${MOMAGEN_MIN_TRAVEL_DIST}-${MOMAGEN_MAX_TRAVEL_DIST}m)"
