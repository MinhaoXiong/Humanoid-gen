...
MOMAGEN_START_DIST_MAX=${MOMAGEN_START_DIST_MAX:-"0.4"}
MOMAGEN_TARGET_DIST_MIN=${MOMAGEN_TARGET_DIST_MIN:-"0.4"}
MOMAGEN_TARGET_DIST_MAX=${MOMAGEN_TARGET_DIST_MAX:-"0.4"}
MOMAGEN_MIN_TRAVEL_DIST=${MOMAGEN_MIN_TRAVEL_DIST:-"0.25"}
MOMAGEN_MAX_TRAVEL_DIST=${MOMAGEN_MAX_TRAVEL_DIST:-"0.75"}
